...
def extract_audio_from_video(video_id):
    ...
    audio_blob_name = video_id.replace('.mp4', '.wav')
...
def put_message_in_queue(queue_name, video_id, audio_blob_name, duration_seconds):
...
if __name__ == "__main__":
    ...
    put_message_in_queue(queue_name, video_id, audio_blob_name, duration_seconds)
